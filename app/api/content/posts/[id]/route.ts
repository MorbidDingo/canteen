...
export async function GET(
  ...
  // Fetch author name (needed for both views)
  ...
  const postWithAuthor = { ...post, authorName: author?.name ?? null };
  ...
  if (isAuthor) {
    ...
    return NextResponse.json({ post: postWithAuthor, attachments, audiences, tags });
  }
