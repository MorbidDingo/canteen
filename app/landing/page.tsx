    ...
    <div className="flex flex-col">
      ...
      <section className="relative flex flex-col items-center justify-center px-4 pt-16 pb-20 sm:pt-24 sm:pb-28 overflow-hidden">
        ...
        >
          {[
            ...
            { icon: Wallet, label: "Cashless Payments", color: "#d4891a" },
      ...
      <section className="px-4 py-16 sm:py-24 bg-muted/30">
        <div className="max-w-5xl mx-auto">
          <ScrollSection>
            <div className="text-center mb-12">
              <Badge className="mb-3 bg-[#d4891a]/10 text-[#d4891a] dark:bg-blue-900/30 dark:text-blue-400 border-[#d4891a]/20 hover:bg-[#d4891a]/10">
                For Schools
              </Badge>
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">
